...
;;
;; Purpose
;;   Error checking wrapper to verify that the argument provided is a game
;;
;; Parameters
;;   source-proc, a string
;;   op, a procedure
;;
;; Produces
;;   op-fun, a procedure
;;
;; Preconditions
;;   op is a function that can be applied to any game (e.g., a list accessor)
;;
;; Postconditions
;;   op-fun accepts a game and returns the value of op applied to that game
;;   op-fun generates an error if given a value that is not a game
(define game-check
...
;;
;; Postconditions
;;   successors-fun is a procedure that takes a state and produces a list,
;;     where each entry is a pair whose car is an action and whose cdr is the
;;     new state resulting from taking that action.
